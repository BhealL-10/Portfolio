...
const A_PROD_ICON_URL = '/assets/images/shared/branding/ape-prod-mark-dark.svg';

const MODULE_SHEET_URLS = {
  plane: new URL('../../assets/images/game/sprites/modules/plane/sheet.png', import.meta.url).href,
  wings: new URL('../../assets/images/game/sprites/modules/wings/sheet.png', import.meta.url).href,
  propulseur: new URL('../../assets/images/game/sprites/modules/thruster/sheet.png', import.meta.url).href,
  reacteur_front: new URL('../../assets/images/game/sprites/modules/front-reactor/sheet.png', import.meta.url).href,
  reacteur_back: new URL('../../assets/images/game/sprites/modules/rear-reactor/sheet.png', import.meta.url).href,
  shield: new URL('../../assets/images/game/sprites/modules/shield/sheet.png', import.meta.url).href,
  souffleur: new URL('../../assets/images/game/sprites/modules/blower/sheet.png', import.meta.url).href,
  wrapper: new URL('../../assets/images/game/sprites/modules/wrapper/sheet.png', import.meta.url).href,
  magnet: new URL('../../assets/images/game/sprites/modules/magnet/sheet.png', import.meta.url).href,
  big_canon: new URL('../../assets/images/game/sprites/modules/big-cannon/sheet.png', import.meta.url).href,
  front_canon: new URL('../../assets/images/game/sprites/modules/front-cannon/sheet.png', import.meta.url).href,
  grappin: new URL('../../assets/images/game/sprites/modules/grappling-hook/sheet.png', import.meta.url).href
} as const;

const HUD_ICON_URLS = {
  plane: new URL('../../assets/images/game/ui/equipment/modules/plane.png', import.meta.url).href,
  wings: new URL('../../assets/images/game/ui/equipment/modules/wings.png', import.meta.url).href,
  propulseur: new URL('../../assets/images/game/ui/equipment/modules/thruster.png', import.meta.url).href,
  reacteur_front: new URL('../../assets/images/game/ui/equipment/modules/front-reactor.png', import.meta.url).href,
  reacteur_back: new URL('../../assets/images/game/ui/equipment/modules/rear-reactor.png', import.meta.url).href,
  shield: new URL('../../assets/images/game/ui/equipment/modules/shield.png', import.meta.url).href,
  souffleur: new URL('../../assets/images/game/ui/equipment/modules/blower.png', import.meta.url).href,
  wrapper: new URL('../../assets/images/game/ui/equipment/modules/wrapper.png', import.meta.url).href,
  magnet: new URL('../../assets/images/game/ui/equipment/modules/magnet.png', import.meta.url).href,
  big_canon: new URL('../../assets/images/game/ui/equipment/modules/big-cannon.png', import.meta.url).href,
  front_canon: new URL('../../assets/images/game/ui/equipment/modules/front-cannon.png', import.meta.url).href,
  grappin: new URL('../../assets/images/game/ui/equipment/modules/grappling-hook.png', import.meta.url).href,
  gouvernail: new URL('../../assets/images/game/ui/equipment/passives/rudder.png', import.meta.url).href,
  bourse: new URL('../../assets/images/game/ui/equipment/passives/purse.png', import.meta.url).href,
  contrebandier: new URL('../../assets/images/game/ui/equipment/passives/map.png', import.meta.url).href,
  longue_vue: new URL('../../assets/images/game/ui/equipment/passives/spyglass.png', import.meta.url).href,
  totem: new URL('../../assets/images/game/ui/equipment/passives/totem.png', import.meta.url).href,
  carte_tresor: new URL('../../assets/images/game/ui/equipment/passives/map.png', import.meta.url).href,
  compas: new URL('../../assets/images/game/ui/equipment/passives/compass.png', import.meta.url).href,
  queue: new URL('../../assets/images/game/ui/equipment/passives/tail.png', import.meta.url).href,
  perroquet: new URL('../../assets/images/game/ui/equipment/passives/parrot.png', import.meta.url).href,
  ceinture: new URL('../../assets/images/game/ui/equipment/passives/belt.png', import.meta.url).href,
  amortisseurs: new URL('../../assets/images/game/ui/equipment/passives/shock-absorbers.png', import.meta.url).href,
