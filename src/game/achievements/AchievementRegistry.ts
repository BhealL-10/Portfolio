...
const shardAchievements: AchievementDefinition[] = [
  ...
  achievement('shards_chain_8', loc('Chapelet d’Éclats', 'String of Shards'), loc('Enchaîner 3 atterrissages Super ou Perfect.', 'Chain 3 Super or Perfect landings.'), 'shards', 'uncommon', 3, { rewardId: reward('face', 5) }),
  ...
  achievement('shards_chain_20', loc('Route de Verre', 'Glass Route'), loc('Enchaîner 2 atterrissages Perfect.', 'Chain 2 Perfect landings.'), 'shards', 'rare', 2, { rewardId: reward('motif', 3) }),
  ...
  achievement('shards_100_without_milestone_reward', loc('Route Sans Prime', 'Rewardless Route'), loc('Atteindre 100 m sans prendre de récompense de milestone.', 'Reach 100m without taking a milestone reward.'), 'shards', 'epic', 1, { hidden: true, rewardId: reward('barbe', 9) })
];
...
const moduleAchievements: AchievementDefinition[] = [
  ...
  achievement('modules_air_combo_3', loc('Escadre de Poche', 'Pocket Air Squadron'), loc('Combiner 3 modules aériens dans une même run.', 'Combine 3 airborne modules in a single run.'), 'modules', 'rare', 3, { hidden: true, rewardId: reward('eyes', 12) })
];
