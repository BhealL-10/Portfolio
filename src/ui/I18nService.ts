...
const uiStrings = {
  fr: {
    ...
    gameAudio: 'Audio',
    gameMusic: 'Musique',
    gameSoundEffects: 'Effets sonores',
    gameVolume: 'Volume',
    gameUiSize: 'Taille UI',
    gameUiSizeSmall: 'Petit',
    gameUiSizeMedium: 'Moyen',
    gameUiSizeLarge: 'Grand',
    gameQuality: 'Qualité',
    gameQualityAuto: 'Auto',
    gameQualityHigh: 'High',
    gameQualityMedium: 'Medium',
    gameQualityLow: 'Low',
    gameQualityUltraLow: 'Ultra Low',
    gameQualityManual: 'Manuel',
    gameQualityRecovery: 'Mode sécurisé',
    gameMute: 'Couper',
    gameUnmute: 'Activer',
    about: 'About / Outro',
    ...
    gameAchievementUnlocked: 'Succès débloqué',
    gameAchievementNoReward: 'Aucun asset avatar',
    gameAchievementsTitle: 'Succès',
    gameAchievementsBody: 'Progression méta, raretés officielles et skins débloqués dans le vrai éditeur de profil.',
    gameAchievementsUnlocked: 'Débloqués',
    gameAchievementsLocked: 'Verrouillés',
    gameAchievementsRewards: 'Skins',
    gameAchievementsHidden: 'Mystères restants',
    gameAchievementsProgress: 'Progression',
    gameAchievementsOpen: 'Ouvrir les succès',
    gameAchievementsClose: 'Fermer les succès',
    gameAchievementsMystery: 'Mystère',
    gameAchievementsReward: 'Asset avatar',
    gameAchievementsProfileBody: 'Débloquez des achievements pour ouvrir de nouveaux skins.',
    gameAchievementsAll: 'Tout',
    gameAchievementsSort: 'Tri',
    gameAchievementsSortDefault: 'Catégorie',
    gameAchievementsSortAcquired: 'Date d’acquisition',
    gameAchievementsSortDifficulty: 'Difficulté',
    gameAchievementsSortRarity: 'Rareté',
    gameAchievementsSortUnlocked: 'Obtenu / non obtenu',
    gameAchievementsNoMatches: 'Aucun achievement ne correspond aux filtres actifs.',
  ...
  en: {
    ...
    gameAudio: 'Audio',
    gameMusic: 'Music',
    gameSoundEffects: 'Sound Effects',
    gameVolume: 'Volume',
    gameUiSize: 'UI size',
    gameUiSizeSmall: 'Small',
    gameUiSizeMedium: 'Medium',
    gameUiSizeLarge: 'Large',
    gameQuality: 'Quality',
    gameQualityAuto: 'Auto',
    gameQualityHigh: 'High',
    gameQualityMedium: 'Medium',
    gameQualityLow: 'Low',
    gameQualityUltraLow: 'Ultra Low',
    gameQualityManual: 'Manual',
    gameQualityRecovery: 'Safe mode',
    gameMute: 'Mute',
    gameUnmute: 'Unmute',
    about: 'About / Outro',
    ...
    gameAchievementUnlocked: 'Achievement unlocked',
    gameAchievementNoReward: 'No skin',
    gameAchievementsTitle: 'Success',
    gameAchievementsBody: 'Meta progression, official rarities and skins unlocked in the real profile editor.',
    gameAchievementsUnlocked: 'Unlocked',
    gameAchievementsLocked: 'Locked',
    gameAchievementsRewards: 'skins',
    gameAchievementsHidden: 'Mysteries left',
    gameAchievementsProgress: 'Progress',
    gameAchievementsOpen: 'Open succès',
    gameAchievementsClose: 'Close succès',
    gameAchievementsMystery: 'Mystery',
    gameAchievementsReward: 'skin',
    gameAchievementsProfileBody: 'Unlock achievements to open more skins.',
    gameAchievementsAll: 'All',
    gameAchievementsSort: 'Sort',
    gameAchievementsSortDefault: 'Category',
    gameAchievementsSortAcquired: 'Acquired date',
    gameAchievementsSortDifficulty: 'Difficulty',
    gameAchievementsSortRarity: 'Rarity',
    gameAchievementsSortUnlocked: 'Unlocked / locked',
    gameAchievementsNoMatches: 'No achievements match the active filters.',
