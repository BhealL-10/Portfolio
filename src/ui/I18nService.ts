...
const uiStrings = {
  fr: {
    ...
    gameAchievementsBody: 'Progression méta, raretés officielles et assets avatar débloqués dans le vrai éditeur de profil.',
    gameAchievementsUnlocked: 'Débloqués',
    gameAchievementsLocked: 'Verrouillés',
    gameAchievementsRewards: 'Assets avatar',
    ...
    gameAchievementsProfileBody: 'Débloquez des achievements pour ouvrir de nouveaux assets avatar.',
  ...
  en: {
    ...
    gameAchievementNoReward: 'No avatar asset',
    gameAchievementsTitle: 'Success',
    gameAchievementsBody: 'Meta progression, official rarities and avatar assets unlocked in the real profile editor.',
    gameAchievementsUnlocked: 'Unlocked',
    gameAchievementsLocked: 'Locked',
    gameAchievementsRewards: 'Avatar assets',
    ...
    gameAchievementsReward: 'Avatar asset',
    gameAchievementsProfileBody: 'Unlock achievements to open more avatar assets.',
