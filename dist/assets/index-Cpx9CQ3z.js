...
`].filter(Kn).join(`
`)),a=rr(a),a=Ho(a,t),a=Vo(a,t),o=rr(o),o=Ho(o,t),o=Vo(o,t),a=Wo(a),o=Wo(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
transformed.z *= focusFlatten;`)},t.customProgramCacheKey=()=>`shard-${e}`,t}function ja(i,e){i.color.copy(as[e].color),i.emissive.copy(as[e].emissive)}function Ya(i,e){const t=i.userData.shaderUniforms;t&&(t.uTime.value=e.time,t.uHover.value=e.hover,t.uDrag.value=e.drag,t.uFocus.value=e.focus,t.uSettled.value=e.settled)}const la=18,qn=2.15;class Zp{constructor(e,t){P(this,"group",new Qt);P(this,"renderPlatforms",!1);P(this,"pool",[]);P(this,"geometry",new ps(1.25,4));P(this,"player",new Qt);P(this,"playerBody");P(this,"cameraPosition",new C);P(this,"cameraLookAt",new C);P(this,"transitionFromPositions",[]);P(this,"transitionToPositions",[]);P(this,"anchors",[]);P(this,"theme");P(this,"state","idle");P(this,"transitionProgress",0);P(this,"visibleWindowStart",0);P(this,"attachedAnchorIndex",0);P(this,"currentTime",0);P(this,"pressureX",-14);P(this,"playerPosition",new C);P(this,"playerVelocity",new C);P(this,"angle",-Math.PI*.58);P(this,"angularSpeed",1.4);P(this,"accelerating",!1);P(this,"score",0);P(this,"highscore",Number(window.localStorage.getItem("portfolio-game-highscore")||0));P(this,"scoreListeners",new Set);this.scene=e,this.theme=t,this.group.visible=!1,this.scene.add(this.group);for(let n=0;n<la;n+=1){const s=qa(t,200+n),r=new Pt(this.geometry,s),a=new Qt;a.add(r),this.group.add(a),this.pool.push({group:a,mesh:r})}this.playerBody=new Pt(new gr(.42,1.2,6),new xi({color:t==="dark"?"#D4BF9B":"#393F4A"})),this.playerBody.rotation.z=-Math.PI/2,this.player.add(this.playerBody),this.player.visible=!1,this.group.add(this.player)}setTheme(e){this.theme=e,this.pool.forEach(t=>ja(t.mesh.material,e)),this.playerBody.material.color.set(e==="dark"?"#D4BF9B":"#393F4A")}get currentState(){return this.state}get currentScore(){return this.score}get bestScore(){return this.highscore}onScoreChange(e){return this.scoreListeners.add(e),()=>this.scoreListeners.delete(e)}getInitialPlatformPositions(e){return this.buildAnchors(Math.max(26,e+4)),this.anchors.slice(0,e).map(t=>new C(t.x,t.y,t.z))}getVisiblePlatformPositions(e){return this.ensureAnchors(this.visibleWindowStart+e+2),this.anchors.slice(this.visibleWindowStart,this.visibleWindowStart+e).map(t=>new C(t.x,t.y,t.z))}startTransition(e){this.transitionFromPositions.splice(0,this.transitionFromPositions.length,...e.map(t=>t.clone())),this.state="transition",this.transitionProgress=0,this.group.visible=!0,this.player.visible=!1,this.player.userData.attached=!1,this.accelerating=!1,this.score=0,this.currentTime=0,this.pressureX=-14,this.buildAnchors(26),this.visibleWindowStart=0,this.transitionToPositions.splice(0,this.transitionToPositions.length,...this.anchors.slice(0,e.length).map(t=>new C(t.x,t.y,t.z))),this.syncTransitionPlatforms(),this.emitScore()}prepareReturnTransition(e){this.transitionFromPositions.splice(0,this.transitionFromPositions.length,...e.map(t=>t.clone())),this.transitionToPositions.splice(0,this.transitionToPositions.length,...this.captureVisiblePlatformPositions(e.length)),this.state="transition",this.transitionProgress=1,this.group.visible=!0,this.player.visible=!1,this.player.userData.attached=!1,this.accelerating=!1,this.syncTransitionPlatforms()}setTransitionProgress(e){this.transitionProgress=e,this.syncTransitionPlatforms()}beginRun(){this.state="running",this.attachedAnchorIndex=0,this.visibleWindowStart=0,this.score=0,this.currentTime=0,this.pressureX=-14,this.angularSpeed=1.4,this.attachToAnchor(0,!1),this.player.visible=!0,this.emitScore()}setAccelerating(e){this.state==="running"&&(this.accelerating=e)}jump(){if(this.state!=="running"||this.player.userData.attached!==!0)return;const e=new C(-Math.sin(this.angle),Math.cos(this.angle),0).normalize(),t=4.9+this.angularSpeed*2.8;this.player.userData.attached=!1,this.playerVelocity.copy(e).multiplyScalar(t),this.playerVelocity.x+=1.05}restart(){this.state!=="idle"&&(this.startTransition(this.anchors.slice(0,10).map(e=>new C(e.x,e.y,e.z))),this.setTransitionProgress(1),this.beginRun())}stop(){this.state="idle",this.group.visible=!1,this.player.visible=!1,this.accelerating=!1}update(e,t){if(!this.group.visible)return;if(this.currentTime=t,this.pool.forEach((s,r)=>{Ya(s.mesh.material,{time:t,hover:.18,drag:0,focus:0,settled:0}),s.group.rotation.y+=e*(.16+r*.01)}),this.state==="transition"){this.syncTransitionPlatforms(),this.cameraPosition.set(2.8,1.8,24),this.cameraLookAt.set(2.8,1.2,0);return}this.state==="running"?(this.ensureAnchors(this.attachedAnchorIndex+20),this.updateRunning(e),this.syncVisiblePlatforms(t)):this.state==="game_over"&&this.syncVisiblePlatforms(t),this.pressureX+=e*(2.35+Math.min(2.2,this.score*.035));const n=Math.max(this.playerPosition.x+3.6,this.pressureX+7.8);this.cameraPosition.set(n,1.4,24),this.cameraLookAt.set(n,1.4,0)}getCameraPose(){return{position:this.cameraPosition.clone(),lookAt:this.cameraLookAt.clone()}}updateRunning(e){if(this.player.userData.attached===!0){const t=this.getResolvedAnchor(this.attachedAnchorIndex),n=this.accelerating?4.2:Math.max(1.45,this.angularSpeed*.98);this.angularSpeed=Xe(this.angularSpeed,n,this.accelerating?2.4:.9,e),this.angle+=this.angularSpeed*e,this.playerPosition.set(t.x+Math.cos(this.angle)*qn,t.y+Math.sin(this.angle)*qn,0),this.player.rotation.z=this.angle+Math.PI/2}else{if(this.playerVelocity.y-=8.8*e,this.playerPosition.x+=this.playerVelocity.x*e,this.playerPosition.y+=this.playerVelocity.y*e,this.player.rotation.z=Math.atan2(this.playerVelocity.y,this.playerVelocity.x),this.tryCaptureAnchor())return;(this.playerPosition.y<-16||this.playerPosition.x<this.pressureX-1.8)&&(this.state="game_over",this.accelerating=!1)}this.player.position.copy(this.playerPosition)}tryCaptureAnchor(){const e=Math.max(0,this.attachedAnchorIndex+1),t=Math.min(this.anchors.length-1,e+3);for(let n=e;n<=t;n+=1){const s=this.getResolvedAnchor(n);if(Math.hypot(this.playerPosition.x-s.x,this.playerPosition.y-s.y)<=s.radius+1.15)return this.attachToAnchor(n,!0),!0}return!1}attachToAnchor(e,t){const n=this.getResolvedAnchor(e);if(this.attachedAnchorIndex=e,this.visibleWindowStart=Math.max(this.visibleWindowStart,Math.max(0,e-3)),this.player.userData.attached=!0,t){const s=this.playerPosition.clone().sub(new C(n.x,n.y,n.z));s.lengthSq()<1e-4&&s.set(1,0,0),s.setLength(qn),this.angle=Math.atan2(s.y,s.x);const r=new C(-Math.sin(this.angle),Math.cos(this.angle),0),a=Math.abs(this.playerVelocity.dot(r));this.angularSpeed=os(a/qn,1.15,4.8),this.playerPosition.set(n.x+s.x,n.y+s.y,0)}else this.angle=-Math.PI*.58,this.angularSpeed=1.45,this.playerPosition.set(n.x+Math.cos(this.angle)*qn,n.y+Math.sin(this.angle)*qn,0);this.playerVelocity.set(0,0,0),this.player.rotation.z=this.angle+Math.PI/2,this.score=e,this.score>this.highscore&&(this.highscore=this.score,window.localStorage.setItem("portfolio-game-highscore",String(this.highscore))),this.emitScore()}emitScore(){this.scoreListeners.forEach(e=>e())}buildAnchors(e){this.anchors.length>0||(this.anchors=[{x:-12,y:.8,z:0,radius:1.45},{x:-4.4,y:1.7,z:0,radius:1.5},{x:3.4,y:.25,z:0,radius:1.45}],this.ensureAnchors(e))}ensureAnchors(e){const t=[[6.9,1.1],[7.4,-1],[7.8,.65],[7.2,1.4],[7.7,-1.45],[8.1,.4]];for(;this.anchors.length<=e;){const n=this.anchors[this.anchors.length-1],s=Math.min(1,this.anchors.length/34),r=t[this.anchors.length%t.length],a=n.x+r[0]+s*2.9,o=os(n.y+r[1],-3.8,4.8);this.anchors.push({x:a,y:o,z:0,radius:1.4+Math.sin(this.anchors.length*.6)*.08})}}syncTransitionPlatforms(){this.pool.forEach((e,t)=>{const n=this.transitionFromPositions[t],s=this.transitionToPositions[t];if(!n||!s){e.group.visible=!1;return}e.group.visible=this.renderPlatforms,e.group.position.set(cn.lerp(n.x,s.x,this.transitionProgress),cn.lerp(n.y,s.y,this.transitionProgress),cn.lerp(n.z,s.z,this.transitionProgress)),e.group.scale.setScalar(1)})}captureVisiblePlatformPositions(e){return this.pool.slice(0,e).map((t,n)=>{if(!t.group.visible){const s=this.getResolvedAnchor(n);return new C(s.x,s.y,s.z)}return t.group.position.clone()})}syncVisiblePlatforms(e){this.ensureAnchors(this.visibleWindowStart+la+2),this.pool.forEach((t,n)=>{const s=this.getResolvedAnchor(this.visibleWindowStart+n);if(!s){t.group.visible=!1;return}t.group.visible=this.renderPlatforms,t.group.position.set(s.x,s.y,s.z),t.group.scale.setScalar(s.radius/1.4),t.group.rotation.x=Math.sin(e*.9+n)*.12})}getResolvedAnchor(e){this.ensureAnchors(e+1);const t=this.anchors[e];if(!t)return{x:0,y:0,z:0,radius:1.4};if(this.score<20)return t;const n=Math.min(1,(this.score-20)/60),s=e*.7+this.currentTime*(.8+n*.55),r=Math.sin(s)*(.35+n*.9),a=e>this.attachedAnchorIndex?Math.cos(s*.85+e*.3)*(.18+n*.55):0;return{x:t.x+a,y:t.y+r,z:t.z,radius:t.radius}}}class Jp{constructor(){P(this,"yaw",0);P(this,"radius",26.5);P(this,"yawTarget",0);P(this,"radiusTarget",26.5);P(this,"height",2.6);P(this,"pose",new C);P(this,"lookAt",new C)}setRadius(e){this.radius=e,this.radiusTarget=e}orbit(e,t){const n=os(e,-18,18);this.yawTarget+=n*.0046}update(e,t){return this.yaw=Xe(this.yaw,this.yawTarget,10,e),this.radius=Xe(this.radius,this.radiusTarget,8,e),this.pose.set(t.x+Math.sin(this.yaw)*this.radius,t.y+this.height,t.z+Math.cos(this.yaw)*this.radius),this.lookAt.copy(t),{position:this.pose.clone(),lookAt:this.lookAt.clone()}}}class Qp{constructor(e,t,n){P(this,"element");P(this,"canvas");P(this,"context");P(this,"content");P(this,"progress");P(this,"logo");P(this,"sites",[]);P(this,"cellCache",[]);P(this,"fragments",[]);P(this,"clickCount",0);P(this,"clickThreshold",8);P(this,"fractureIndex",0);P(this,"state","idle");P(this,"opacity",1);P(this,"shatterElapsed",0);P(this,"onBroken",null);P(this,"onHidden",null);P(this,"onPointerDown",e=>{if(this.state!=="idle")return;const t=this.canvas.getBoundingClientRect(),n=e.clientX-t.left,s=e.clientY-t.top;this.addFractureCluster(n,s),this.clickCount+=1,this.progress.style.setProperty("--intro-progress",String(this.clickCount/this.clickThreshold)),this.progress.textContent=`${this.clickCount}/${this.clickThreshold}`,this.clickCount>=this.clickThreshold?this.startShatter():this.draw()});P(this,"resize",()=>{this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight,this.draw()});this.i18n=t,this.theme=n,this.element=document.createElement("div"),this.element.className="intro-layer",this.canvas=document.createElement("canvas"),this.canvas.className="intro-layer__canvas";const s=this.canvas.getContext("2d");if(!s)throw new Error("Canvas 2D context unavailable");this.context=s,this.content=document.createElement("div"),this.content.className="intro-layer__content",this.content.innerHTML=`
